...
# Tue Jun 23 21:54:18 CEST 2015
# DO NOT MODIFY


# +-----------------------------------
# | 
# | i2c_interface "i2c_interface" v1.0
# | Soltys 2015.06.23.21:54:18
# | IC for comunication with RTC
# | 
# | D:/altera/91sp2/ip/i2c_avalon/hdl/i2c_interface.vhd
# | 
# |    ./i2c_clkgen.vhd syn, sim
# |    ./i2c_core.vhd syn, sim
# |    ./i2c_interface.vhd syn, sim
# | 
# +-----------------------------------
...
# | 
set_module_property DESCRIPTION "IC for comunication with RTC"
set_module_property NAME i2c_interface
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property GROUP "Interface Protocols/Serial"
set_module_property AUTHOR Soltys
set_module_property DISPLAY_NAME i2c_interface
set_module_property TOP_LEVEL_HDL_FILE i2c_interface.vhd
set_module_property TOP_LEVEL_HDL_MODULE i2c_interface
...
# | files
# | 
add_file i2c_clkgen.vhd {SYNTHESIS SIMULATION}
add_file i2c_core.vhd {SYNTHESIS SIMULATION}
add_file i2c_interface.vhd {SYNTHESIS SIMULATION}
# | 
# +-----------------------------------
...
add_interface_port conduit_end scl export Bidir 1
